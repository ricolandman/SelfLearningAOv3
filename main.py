...
if __name__ == '__main__':
    ...
    def reward_function(strehl,vapp_strehl,contrast):
    ...
    env_params['num_iterations'] = 300  #Number of iterations per episode
    ...
    env_params['num_airy'] = 20 #Size of focal plane in number of airy rings
    ...
    env_params['reconstruction_matrix_name'] =  'reconstruction_matrix_xinetics25.txt'
    ...
    params['critic_lr_decay'] = np.exp(np.log(0.5)/300.)
    ...
    params['minibatch_size'] = 64 #Batch size for training critic and actor
    params['num_training_batches'] = 100  #Number of batches to train on every episode
    params['optimization_length'] = 1 #Size of the history/number of steps to use in the BPTT
    params['initialization_length'] = 0
    ...
    params['warmup'] = 5 #Number of episodes to follow a random policy before training the actor
    params['critic_warmup'] = 5 #Number of episodes to collect samples before starting to train the critic
    params['action_scaling'] = 1     #Maximum possible action
    params['use_integrator'] = 0
    ...
    params['noise_decay'] = np.exp(np.log(0.5)/400.)            #noise decay factor

    #---------------Save/load parameters-------------------
    params['max_episodes']= 1000            #Number of episodes to train for

    params['savename'] = "vikram_setup_test"
    ...
    params['save_interval'] = 20    #Number of episodes inbetween saves
    ...
    params['min_episodes']=20       #Minimum number of episodes before early stopping
    ...
    #-------------Other-----------------------
    params['make_debug_plots'] = False #Wether to plot statistics of gradients and train curve
